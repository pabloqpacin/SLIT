...
class Board:
    def __init__(self, dim_size, num_bombs):
        # let's keep track of these parameters. they'll be useful later
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            ...
            col = loc % self.dim_size # we want the remainder to tell us what index in that row to l.....
    ...
    def dig(self, row, col):
        ...
        # if our initial dig didn't hi ta bomb, we *shouldn't* hit a bomb here
        return True
...
def play(dim_size=10, num_bombs=10):
    ...
    # Step 2: show the user the bomb and ask where they want to dig
