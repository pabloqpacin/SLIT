...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        # first, we want to tech if the previous move is a winner
        ...
        if player == max_player:
            ...
            best = {'position': None, 'score': math.inf} # each scroe should minimize 
        ...
        for possible_move in state.available_moves():
            ...
            sim_score['position'] = possible_move # otherwise this will get messedup from the recursoin
