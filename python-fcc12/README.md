...
Well yes I uplodaded the project files to GitHub right after finishing the tutorial because sharing is caring... Butv tbf I didn't even use **git** back then and the project files are likely to be a pretty mess atm. So it is time to go through the video and the code again commenting and explaining whatever is happening in each file. Let's-a-go!
...
Change the MadLibs script and improve general commenting for clarity.